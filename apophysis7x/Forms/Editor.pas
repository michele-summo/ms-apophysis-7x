...
type
  TEditForm = class(TForm)
    ...
    editPivotY: TEdit;
    editPivotX: TEdit;
    mnuLinkPrexformClick: TMenuItem;
...
//    procedure ValidateValue(Sender: TObject);
    ...
    procedure mnuLinkPrexformClickClick(Sender: TObject);
...
//    SelectedTriangle: integer; // outside only for scripting
    ...
    VarsCache: array[0..65536] of double; // hack: to prevent slow valuelist redraw
