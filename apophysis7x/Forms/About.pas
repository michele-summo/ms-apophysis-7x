...
type
  TAboutForm = class(TForm)
    ...
    procedure HackersClick(Sender: TObject);
  private
...
procedure TAboutForm.HackersClick(Sender: TObject);
begin
  ShellExecute(ValidParentForm(Self).Handle, 'open', 'https://www.michelesummo.it',
